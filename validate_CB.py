...
camera_parameters_L_file ='calib_nico_L.yaml'
camera_parameters_R_file ='calib_nico_R.yaml'
stereo_parameters_file ='nico_stereo_calib_params.yml'
stereo_map_file = 'test'
images_left = glob.glob('/Users/jacobsimon/Desktop/nico_stereo/left/*')
images_right = glob.glob('/Users/jacobsimon/Desktop/nico_stereo/right/*')
...
if os.path.exists(stereo_parameters_file):
    ...
    objpoints_L, imgpoints_L = AR_functions.calibrate_fast(images_left_sort, chessboardSize)
    cv.destroyAllWindows()
    objpoints_R, imgpoints_R = AR_functions.calibrate_fast(images_right_sort, chessboardSize)
    cv.destroyAllWindows()
